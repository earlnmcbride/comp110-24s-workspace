...
from lessons.sum3_4 import sum

def test_sum_empty() -> None:
    """Sum of empty list should return 0"""
    assert sum ([]) == 0 # assert the sum of an empty list and returns 0
...
def test_sum_positive() -> None:
    """Sume of positive numbers should return sum of those positive numbers."""
    test: list[int] = [2,4,6]
    assert sum(test) == 12
